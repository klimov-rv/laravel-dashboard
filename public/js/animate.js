...
var __WEBPACK_AMD_DEFINE_RESULT__;function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
(function (modules, entry, mainEntry, parcelRequireName, globalName) {
  ...
  var nodeRequire =  true && typeof module.require === 'function' && module.require.bind(module);
  ...
  "cVgJb": [function (require, module, exports) {
    ...
    function hmrDownload(asset) {
      if (asset.type === "js") {
        if (typeof document !== "undefined") {
          ...
          // Worker scripts
          if (asset.outputFormat === "esmodule") return __webpack_require__("./resources/js lazy recursive")(asset.url + "?t=" + Date.now());else return new Promise(function (resolve, reject) {
            try {
    ...
    function hmrApplyUpdates(_x) {
      return _hmrApplyUpdates.apply(this, arguments);
    }
    function _hmrApplyUpdates() {
      _hmrApplyUpdates = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(assets) {
  ...
  "ebWYT": [function (require, module, exports) {
    ...
    // preview Items
    var previewItems = _toConsumableArray(document.querySelectorAll(".preview > .preview__item"));
    // initial rows
    var rows = _toConsumableArray(document.querySelectorAll(".row"));
    // cover element
    var cover = document.querySelector(".cover");
    // close ctrl
    var closeCtrl = document.querySelector(".preview > .preview__close");
    ...
    var currentRow = -1;
    var mouseenterTimeline;
    var _loop = function _loop() {
      var row = _rowsArr[_i2];
      row.DOM.el.addEventListener("mouseenter", function () {
        if (isOpen) return;
        (0, _gsap.gsap).killTweensOf([row.DOM.images, row.DOM.title]);
        mouseenterTimeline = (0, _gsap.gsap).timeline().addLabel("start", 0).to(row.DOM.images, {
          ...
          onComplete: function onComplete() {
            return row.DOM.titleWrap.classList.add("cell__title--switch");
          }
        }, "start").to(row.DOM.title, {
          duration: 0.5,
          ease: "expo",
      ...
      row.DOM.el.addEventListener("mouseleave", function () {
        if (isOpen) return;
        (0, _gsap.gsap).killTweensOf([row.DOM.images, row.DOM.title]);
        (0, _gsap.gsap).timeline().addLabel("start").to(row.DOM.images, {
          ...
          yPercent: -100,
          onComplete: function onComplete() {
            return row.DOM.titleWrap.classList.remove("cell__title--switch");
          }
        }, "start").to(row.DOM.title, {
          duration: 0.5,
          ease: "expo",
      ...
      row.DOM.el.addEventListener("click", function () {
        if (isAnimating) return;
        isAnimating = true;
        isOpen = true;
        currentRow = rowsArr.indexOf(row);
        (0, _gsap.gsap).killTweensOf([cover, rowsArr.map(function (row) {
          return row.DOM.title;
        })]);
        ...
        .to(rowsArr.map(function (row) {
          return row.DOM.title;
        }), {
          duration: 0.5,
          ease: "power4.inOut",
          yPercent: function yPercent(_, target) {
            return target.getBoundingClientRect()["top"] > row.DOM.el.getBoundingClientRect()["top"] ? 100 : -100;
          },
          rotation: 0
        }, "start").add(function () {
          var _row$previewItem$DOM$;
          mouseenterTimeline.progress(1, false);
          var flipstate = (0, _flip.Flip).getState(row.DOM.images, {
            simple: true
          });
          (_row$previewItem$DOM$ = row.previewItem.DOM.grid).prepend.apply(_row$previewItem$DOM$, _toConsumableArray(row.DOM.images));
          ...
          .to(row.previewItem.DOM.images, {
            ...
            startAt: {
              ...
              yPercent: function yPercent() {
                return (0, _gsap.gsap).utils.random(0, 200);
              }
            },
            scale: 1,
            opacity: 1,
    ...
    for (var _i2 = 0, _rowsArr = rowsArr; _i2 < _rowsArr.length; _i2++) {
      _loop();
    }
    ...
    closeCtrl.addEventListener("click", function () {
      ...
      (0, _gsap.gsap).timeline({
        ...
        onStart: function onStart() {
          return body.classList.remove("oh");
        },
        onComplete: function onComplete() {
      ...
      }).addLabel("start", 0).to([row.DOM.images, row.previewItem.DOM.images], {
        scale: 0,
        opacity: 0,
        stagger: 0.04,
        onComplete: function onComplete() {
          var _row$DOM$imagesWrap;
          return (_row$DOM$imagesWrap = row.DOM.imagesWrap).prepend.apply(_row$DOM$imagesWrap, _toConsumableArray(row.DOM.images));
        }
    ...
    Promise.all([(0, _utils.preloadImages)(".cell__img-inner")]).then(function () {
  ...
  "72Dku": [function (require, module, exports) {
    ...
    parcelHelpers["export"](exports, "preloadImages", function () {
      return preloadImages;
    });
    var imagesLoaded = require("ecf661bb293af698");
    /**
     * Preload images
  ...
  "aYzyZ": [function (require, module, exports) {
    ...
    (function (window1, factory) {
      ...
      if (0, module.exports)
        // CommonJS
        module.exports = factory(window1, require("4de5477e881316c9"));else
        // browser global
      ...
      */
      ImagesLoaded.prototype.addElementImages = function (elem) {
        ...
        var _iterator2 = _createForOfIteratorHelper(childImgs),
          _step2;
        try {
      ...
      */
      ...
      ImagesLoaded.prototype.check = function () {
        ...
        var onProgress = function onProgress(image, elem, message) {
          ...
          setTimeout(function () {
            _this6.progress(image, elem, message);
          });
        };
      ...
      ImagesLoaded.prototype.progress = function (image, elem, message) {
        ...
        if (this.options.debug && console) console.log("progress: ".concat(message), image, elem);
      };
  ...
  "d87VK": [function (require, module, exports) {
    var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    parcelHelpers.defineInteropFlag(exports);
    /**
     ...
     */
    function Row(DOM_el, DOM_previewItem) {
      ...
      this.DOM.images = _toConsumableArray(this.DOM.imagesWrap.querySelectorAll(".cell__img"));
    });
  }, {
    "./previewItem": "aA6St",
    "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3"
  }],
  "aA6St": [function (require, module, exports) {
    /**
     * Class representing a Preview Item (.preview__item)
     */
    var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers["export"](exports, "PreviewItem", function () {
      return PreviewItem;
    });
    var PreviewItem = /*#__PURE__*/_createClass(
    // DOM elements
    ...
    function PreviewItem(DOM_el) {
      ...
      this.DOM.images = _toConsumableArray(this.DOM.grid.querySelectorAll(".cell__img"));
    });
  }, {
    "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3"
  }],
  "fPSuC": [function (require, module, exports) {
    ...
    var gsapWithCSS = (0, _gsapCoreJs.gsap).registerPlugin((0, _csspluginJs.CSSPlugin)) || (0, _gsapCoreJs.gsap),
  ...
  "05eeC": [function (require, module, exports) {
    var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    parcelHelpers.defineInteropFlag(exports);
      ...
      _ticker = function () {
        var _getTime = Date.now,
          ...
          _tick = function _tick(v) {
            ...
            if (dispatch) for (_i = 0; _i < _listeners.length; _i++) {
      ...
      */
      ...
      _propagateYoyoEase = function _propagateYoyoEase(timeline, isYoyo) {
        var child = timeline._first,
          ease;
        while (child) {
          if (child instanceof Timeline) _propagateYoyoEase(child, isYoyo);else if (child.vars.yoyoEase && (!child._yoyo || !child._repeat) && child._yoyo !== isYoyo) {
            if (child.timeline) _propagateYoyoEase(child.timeline, isYoyo);else {
              ease = child._ease;
      ...
      _proto2.getChildren = function getChildren(nested, tweens, timelines, ignoreBeforeTime) {
        ...
        while (child) {
          if (child._start >= ignoreBeforeTime) {
            if (child instanceof Tween) tweens && a.push(child);else {
        ...
        if (!tl || keyframes && !vars.stagger) {
          ...
          for (i = 0; i < targets.length; i++) {
            ...
            if (!harness || harnessVars) {
              for (p in cleanVars) {
                if (_plugins[p] && (plugin = _checkPlugin(p, cleanVars, tween, index, target, fullTargets))) plugin.priority && (hasPriority = 1);else ptLookup[p] = pt = _addPropTween.call(tween, target, p, "get", cleanVars[p], index, fullTargets, 0, vars.stringFilter);
              }
            }
    ...
    */ /* eslint-disable */
    ...
    var _win,
      ...
      _convertToUnit = function _convertToUnit(target, property, value, unit) {
        ...
        cache = parent._gsap;
        if (cache && toPercent && cache.width && horizontal && cache.time === (0, _gsapCoreJs._ticker).time && !cache.uncache) return (0, _gsapCoreJs._round)(curValue / cache.width * amount);else {
      ...
      _tweenComplexCSSString = function _tweenComplexCSSString(target, prop, start, end) {
        ...
        var pt = new (0, _gsapCoreJs.PropTween)(this._pt, target.style, prop, 0, 1, (0, _gsapCoreJs._renderComplexString)),
          index = 0,
          matchIndex = 0,
          a,
          result,
      ...
      */
      ...
      _getMatrix = function _getMatrix(target, force2D) {
        var cache = target._gsap || (0, _gsapCoreJs._getCache)(target),
          style = target.style,
      ...
      _addRotationalPropTween = function _addRotationalPropTween(plugin, target, property, startNum, endValue) {
        var cap = 360,
          isString = (0, _gsapCoreJs._isString)(endValue),
          ...
          if (specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);else if (p.substr(0, 2) === "--") {
            ...
            if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !_complexExp.test(endValue) && p in style) {
              ...
              if (p in target)
                ...
                this.add(target, p, startValue || target[p], relative ? relative + endValue : endValue, index, targets);else {
    ...
    */ /* eslint-disable */
    ...
    var _id = 1,
      ...
      _makeAbsolute = function _makeAbsolute(elState, fallbackNode, ignoreBatch) {
        ...
        } // record paddings as px-based because if removed from grid, percentage-based ones could be altered.
      ...
      _filterComps = function _filterComps(comps, targets) {
        if (targets !== true) {
          ...
          comps = comps.filter(function (c) {
            if (targets.indexOf((c.sd < 0 ? c.b : c.a).element) !== -1) return true;else {
    ...
    var ElementState = /*#__PURE__*/function () {
      ...
      _proto2.update = function update(props, simple) {
        var self = this,
          ...
          m = simple ? new (0, _matrixJs.Matrix2D)(1, 0, 0, 1, bounds.left + (0, _matrixJs._getDocScrollLeft)(), bounds.top + (0, _matrixJs._getDocScrollTop)()) : (0, _matrixJs.getGlobalMatrix)(element, false, false, true);
    ...
    "./utils/matrix.js": "khPcO",
    "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3"
  }],
  "khPcO": [function (require, module, exports) {
    /*!
     * matrix 3.11.3
     * https://greensock.com
     *
    ...
    */ /* eslint-disable */
    var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    parcelHelpers.defineInteropFlag(exports);
    parcelHelpers["export"](exports, "Matrix2D", function () {
      return Matrix2D;
    });
    ...
    //     tx = m.a * x + m.c * y + m.e
    //     ty = m.b * x + m.d * y + m.f
    parcelHelpers["export"](exports, "getGlobalMatrix", function () {
      return getGlobalMatrix;
    });
    parcelHelpers["export"](exports, "_getDocScrollTop", function () {
    ...
    parcelHelpers["export"](exports, "_getDocScrollLeft", function () {
      return _getDocScrollLeft;
    });
    parcelHelpers["export"](exports, "_setDoc", function () {
      return _setDoc;
    });
    parcelHelpers["export"](exports, "_isFixed", function () {
      return _isFixed;
    });
    parcelHelpers["export"](exports, "_getCTM", function () {
      return _getCTM;
    });
    var _doc,
      _win,
...
}, ["cVgJb", "ebWYT"], "ebWYT", "parcelRequire9f8e");
...
webpackEmptyAsyncContext.id = "./resources/js lazy recursive";
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/animate.js");
/******/ 	
/******/ })()
;